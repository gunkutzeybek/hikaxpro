...
def fun1(e, t):
    ...
    for l in range(0, len(e), 16):
        ...
        c = f[7]
        for d in range(0, 64):
            I[d] = e[d + l] if d < 16 else m(m(m(C(I[d - 2], 17) ^ C(I[d - 2], 19) ^ rs(I[d - 2], 10), I[d - 7]),
                                               C(I[d - 15], 7) ^ C(I[d - 15], 18) ^ rs(I[d - 15], 3)), I[d - 16])
...
def fun0(e):
    ...
    for n in range(0, 4 * len(e)):
        t += '0123456789abcdef'[e[n >> 2] >> 8 * (3 - n % 4) + 4 & 15] + '0123456789abcdef'[
            e[n >> 2] >> 8 * (3 - n % 4) & 15]
    return t
